            ...
            {preview ? (
              <>
                <div className="flex justify-around items-center">
                  ...
                  <Link href={"/"} className="text-black"><Image src={'/logo.png'} height={50} width={50} alt='n;o ' priority></Image></Link>
                </div>            </>
            ) : (
              <>
                <div className="flex justify-around items-center">
                  ...
                  <Link href={"/"} className="text-black"><Image src={'/logo.png'} height={50} width={50} alt='n;o
