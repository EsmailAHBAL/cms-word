          ...
          <div className="grid-cols-2 w-full col-span-2">
            <p className="">
              <Link
                ...
                className="hover:text-gray-700 line-clamp-3  
                   pt-8 md:text-3xl md:mt-10 md:first-letter:text-5xl lg:text-sm lg:mt-2 lg:pt-2
                  text-black font-extralight ease-in-out duration-700 hover:text-sm transition-all "
